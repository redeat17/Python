import csv
import os
path = "/Users/redea/Desktop/Python-Challenge/Python Mini-HW/2.11-HW_UdemyZip/Resources/web_starter.csv"
output = "/Users/redea/Desktop/Udemy-CSV/Udemy.csv"
udemy_csv = os.path.join(path)
